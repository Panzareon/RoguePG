...
{
    public:
        enum CharacterClassEnum{CharacterClassMage, CharacterClassBarbarian, CharacterClassPaladin, CharacterClassThief, CharacterClassCleric, CharacterClassWizard, CharacterClassVampire, CHARACTER_CLASS_END};
