...
{
    //ctor
    m_rect.left = (float)(x * TileMap::GetTileWidth());
    m_rect.top = (float)(y * TileMap::GetTileWidth());
    m_rect.width = (float)(TileMap::GetTileWidth());
    m_rect.height = (float)(TileMap::GetTileWidth());
